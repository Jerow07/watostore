              ...
              {items.length === 0 ? (
                ...
                >
                  ...
                  <Link
                    ...
                    onClick={closeCart}
                    style={{ marginTop: 8, fontSize: 14, textDecoration: 'none' }}
                  >
                    Explorar catálogo
                  </Link>
                </div>
                ...
                <>
                  {items.map((item) => (
                    ...
                    >
                      ...
                      <div style={{ minWidth: 0 }}>
                        ...
                        <span
                          style={{
                            ...
                            borderRadius: 3,
                            background:
                              item.accountType === 'primary'
                                ? 'rgba(230,4,18,0.15)'
                                : 'rgba(76,195,227,0.15)',
                            color:
                              item.accountType === 'primary' ? '#F14555' : '#4CC3E3',
                            marginBottom: 6,
                          }}
                        >
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginTop: 4 }}>
                          <button
                            onClick={() => updateQty(item.gameId, item.accountType, item.qty - 1)}
                            style={{
                              width: 22,
                              height: 22,
                              borderRadius: 4,
                      ...
                      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: 8 }}>
                        ...
                        <button
                          onClick={() => removeItem(item.gameId, item.accountType)}
                          style={{
                            color: 'var(--fg-3)',
                            background: 'none',
                            border: 'none',
                  ...
                  {items.length === 1 && (
                    <div
                      style={{
                        padding: 14,
                        border: '1px dashed rgba(76,195,227,0.3)',
                        borderRadius: 10,
                        background: 'rgba(76,195,227,0.04)',
                        fontSize: 12,
                        color: '#4CC3E3',
                        fontFamily: 'JetBrains Mono, monospace',
                        textAlign: 'center',
