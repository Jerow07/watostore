...
export default function Contact() {
  ...
  return (
    <div style={{ paddingTop: 64, position: 'relative', zIndex: 1 }}>
      <div style={{ padding: '72px 48px 60px', textAlign: 'center', borderBottom: '1px solid var(--border)' }}>
        <p className="section-eyebrow" style={{ display: 'inline-block', marginBottom: 12 }}>CONTACTO</p>
        <h1 style={{ fontFamily: '"Space Grotesk",sans-serif', fontSize: 52, fontWeight: 700, letterSpacing: '-0.03em', lineHeight: 1 }}>
          Hablemos
        </h1>
      ...
      <div style={{ padding: '56px 48px 80px', maxWidth: 1200, margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 360px 280px', gap: 32, alignItems: 'start' }}>

        {/* Form */}
        <div style={{ background: 'var(--bg-1)', border: '1px solid var(--border)', borderRadius: 16, padding: 32 }}>
          {sent ? (
            ...
            <>
              ...
              <div style={{ display: 'grid', gap: 14 }}>
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 14 }}>
                  <div>
                    <label style={{ fontSize: 11, color: 'var(--fg-3)', fontFamily: 'JetBrains Mono, monospace', textTransform: 'uppercase', letterSpacing: '0.1em', display: 'block', marginBottom: 6 }}>Nombre</label>
                    <input className="wato-input" placeholder="Tu nombre" value={form.name} onChange={(e) => setForm((f) => ({ ...f, name: e.target.value }))} />
                  </div>
                  <div>
                    <label style={{ fontSize: 11, color: 'var(--fg-3)', fontFamily: 'JetBrains Mono, monospace', textTransform: 'uppercase', letterSpacing: '0.1em', display: 'block', marginBottom: 6 }}>Email</label>
                ...
                <div>
                  <label style={{ fontSize: 11, color: 'var(--fg-3)', fontFamily: 'JetBrains Mono, monospace', textTransform: 'uppercase', letterSpacing: '0.1em', display: 'block', marginBottom: 6 }}>Asunto</label>
                ...
                <div>
                  <label style={{ fontSize: 11, color: 'var(--fg-3)', fontFamily: 'JetBrains Mono, monospace', textTransform: 'uppercase', letterSpacing: '0.1em', display: 'block', marginBottom: 6 }}>Mensaje</label>
                  <textarea
        ...
        <div style={{ display: 'grid', gap: 12, alignContent: 'start' }}>
          {[
            { icon: <MessageSquare size={20} />, title: 'WhatsApp', sub: 'Respuesta inmediata', detail: '+54 11 0000-0000', href: 'https://wa.me/5491100000000', color: '#4CC3E3' },
